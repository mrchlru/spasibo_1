      ...
      <div className={styles.faqContainer}>
        ...
        <div className={styles.faqSection}>
          ...
          <div className={styles.faqItem}>
            ...
            <p>Перейдите в раздел "Переводы" с главной страницы, найдите коллегу через поиск, укажите количество спасибок и опционально добавьте сообщение. Подтвердите перевод.</p>
          </div>
        ...
        <div className={styles.faqSection}>
          ...
          <div className={styles.faqItem}>
            ...
            <p>Счетчики частей билетов сбрасываются ежедневно в полночь. Собранные билеты сохраняются и могут быть использованы в любое время.</p>
          </div>
        </div>
        ...
        {/* Мини-игра */}
        <div className={styles.faqSection}>
          <h3 className={styles.sectionTitle}>Мини-игра Dino Game</h3>
          
          <div className={styles.faqItem}>
            <h4>Что такое Dino Game?</h4>
            <p>Dino Game - это развлекательная мини-игра в приложении, где вы управляете динозавриком, избегая препятствий. Игра доступна из раздела меню.</p>
          </div>

          <div className={styles.faqItem}>
            <h4>Можно ли выиграть спасибки в игре?</h4>
            <p>На данный момент Dino Game является развлекательной игрой и не дает призов в спасибках. Это просто способ развлечься в перерыве.</p>
          </div>
        </div>
