      ...
      <div className={styles.faqContainer}>
        ...
        <div className={styles.faqSection}>
          ...
          <div className={styles.faqItem}>
            ...
            <p>Для участия в рулетке нужно собрать билет из 4 частей. Части билетов можно получить от коллег или в других активностях. После сборки билета вы можете крутить рулетку и выигрывать спасибки.</p>
          </div>
