    ...
    <PageLayout title="Часто задаваемые вопросы">
      ...
      <div className={styles.faqContainer}>
        <div className={styles.faqItem}>
          ...
          <p>Вы можете получить баллы от любого коллеги в качестве благодарности за помощь, прокручивая рулетку. Также "Спасибки" автоматически начисляются на день рождения.</p>
        </div>
