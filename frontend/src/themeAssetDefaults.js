...
export const THEME_ASSET_DEFAULTS = {
  summer: {
    ...
    page_header_logo: 'https://i.postimg.cc/YqcmJB37/6.webp',
    page_header_divider: 'https://i.postimg.cc/bvMHvzWv/Line-18.webp',
    section_slider_knob: '/assets/slider/mug-knob.avif',
